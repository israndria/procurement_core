...
WORKBOOK_OPEN_DATE_CODE = (
    ...
    "    ' Ctrl+S/Save harus selalu memperbarui snapshot XML canonical.\n"
    "    ' Guard mencegah re-entry bila Excel memicu event saat rangkaian save.\n"
    "    Static saveGuard As Boolean\n"
    "    If saveGuard Then Exit Sub\n"
    "    If Me.ReadOnly Then Exit Sub\n"
    "    If SaveAsUI And Len(Trim$(Me.Path)) = 0 Then Exit Sub\n"
    "\n"
    "    saveGuard = True\n"
    "    On Error GoTo SnapshotFailed\n"
    "    Application.EnableEvents = False\n"
    "    ModDraftPaketPL.SetSilentPL True\n"
    "    ModDraftPaketPL.SaveDataPL\n"
    "    ModDraftPaketPL.SetSilentPL False\n"
    "    Application.EnableEvents = True\n"
    "    saveGuard = False\n"
    "    Exit Sub\n"
    "\n"
    ...
    "    Application.EnableEvents = True\n"
    "    Cancel = True\n"
    "    MsgBox \"Penyimpanan dibatalkan: snapshot XML gagal dibuat.\" & vbCrLf & Err.Description, vbCritical, \"Save Data PL\"\n"
    "    saveGuard = False\n"
    "End Sub\n"
)
